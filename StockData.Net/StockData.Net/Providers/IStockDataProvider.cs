...
/// <summary>
/// Unified interface for stock data retrieval from any provider
/// </summary>
public interface IStockDataProvider
{
    /// <summary>
    /// Unique identifier for this provider (e.g., "yahoo_finance")
    /// </summary>
    ...
    /// <param name="ticker">Stock ticker symbol (e.g., "AAPL")</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>JSON string containing stock information, which may include country information when available</returns>
    Task<string> GetStockInfoAsync(string ticker, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets news articles for a specific ticker
    /// </summary>
    /// <param name="ticker">Stock ticker symbol (e.g., "AAPL")</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    Task<string> GetFinancialStatementAsync(string ticker, FinancialStatementType statementType, CancellationToken cancellationToken = default);
    ...
    Task<string> GetHolderInfoAsync(string ticker, HolderType holderType, CancellationToken cancellationToken = default);
    ...
    Task<string> GetOptionChainAsync(string ticker, string expirationDate, OptionType optionType, CancellationToken cancellationToken = default);
